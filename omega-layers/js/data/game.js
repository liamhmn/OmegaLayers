var game = {
    ...
    achievements: [
        ...
        new Achievement("How is this happening?", "Reach Layer 1e100", "10 DTg", () => game.metaLayer.layer.gte(1e100)),
        ...
        new Achievement("Lucky Sevens", "Buy your first <span>α<sub>7</sub></span> Generator", "<span>α<sub>7</sub></span>", () => game.layers[0] && game.layers[0].generators[6].bought.gt(0)),
        ...
        new Achievement("Octacore Ten", "Have 10 <span>α<sub>8</sub></span> Generator", "<span>α<sub>8</sub></span>", () => game.layers[0] && game.layers[0].generators[7].bought.gte(10)),
        ...
        new Achievement("Extra Beta Power!", "Have 10 <span>β<sub>P<sub>1</sub></sub></span> Generator", "<span>β<sub>P<sub>1</sub></sub></span>", () => game.layers[1] && game.layers[1].powerGenerators[0].bought.gte(10)),
