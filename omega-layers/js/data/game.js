var game = {
    ...
    achievements: [
        ...
        new Achievement("One with the Nanillion", "Reach 1e3,000,000,003 α", "α 11", () => game.layers[0] && game.layers[0].resource.gt("1e3000000003")),
        new Achievement("One with the Picillion", "Reach 1e3,000,000,000,003 α", "α 11", () => game.layers[0] && game.layers[0].resource.gt("1e3000000000003")),
        ...
        new Achievement("Bruh...", "Reach 1ee50 α", "α 13", () => game.layers[0] && game.layers[0].resource.gt("1ee50")),
