var game = {
    ...
    achievements: [
        ...
        new Achievement("Gamma Boost", "Reach one billion γ-Power", "<span>γ<sub>P</sub></span>", () => game.layers[1] && game.layers[1].power.gte(1e6)),
        ...
        new Achievement("Delta Boost", "Reach 1e20 δ-Power", "<span>δ<sub>P</sub></span>", () => game.layers[1] && game.layers[1].power.gte(1e6)),
